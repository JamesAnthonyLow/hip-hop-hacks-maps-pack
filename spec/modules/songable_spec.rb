...
describe "#get_lyrics_from_link" do
  before(:each) do
    @songable = DummyClass.new
    @songable.extend(Songable)
  end
  it "Returns properly formatted lyrics" do
    lyrics = "Yeah, I'm out that Brooklyn, now I'm down in Tribeca
...
These streets will make you feel brand new
Big lights will inspire you
Let's hear it for New York".gsub("\n", "").gsub(" ", "")

result = @songable.get_lyrics_from_link("http://genius.com/Jay-z-empire-state-of-mind-lyrics").gsub("\n", "").gsub(" ", "")
expect(result).to eq lyrics
  end
end
